...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR cmdArgs, int cmdShow)
{
	...
	glDialog.setWidth(WINDOW_WIDTH);
	...
	formCtrl.setMainHandle(mainCtrl.getHandle());
	...
	CheckMenuItem(GetMenu(statusHandle), IDC_SYNC_DISPLAY, MF_CHECKED);
	CheckMenuItem((HMENU)IDC_STATUSBAR, IDC_SYNC_DISPLAY, MF_CHECKED);
	modelGL.simulator.initViewController(&formCtrl);
	modelGL.simulator.init();
	...
	while (modelGL.simulator.getInStep()){/*simple spin PIEPIEPIE*/};
